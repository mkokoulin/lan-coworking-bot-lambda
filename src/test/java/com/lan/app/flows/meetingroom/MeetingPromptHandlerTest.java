...
@QuarkusTest
class MeetingPromptHandlerTest {

    @Inject
    MeetingPromptHandler handler;
    ...
    private static UpdateContext ctx() {
        return new UpdateContext(100L, "private", 200L, null, "/meetingroom", null, null, false, "bob", null, null, null);
    }

    @Test
    void handle_sendsCalendarAndAdvancesToWaitDate() {
        Session s = session();
