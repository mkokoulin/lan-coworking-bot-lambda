...
@QuarkusTest
class StartLoginHandlerTest {

    @Inject
    StartLoginHandler handler;
    ...
    private static UpdateContext ctx() {
        return new UpdateContext(100L, "private", 200L, null, "/login", null, null, false, "bob", null, null, null);
    }

    @Test
    void handle_promptsForPhoneAndAdvancesToLoginPhone() {
        Session s = session();
