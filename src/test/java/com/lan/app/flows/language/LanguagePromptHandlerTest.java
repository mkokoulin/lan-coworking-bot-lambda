...
@QuarkusTest
class LanguagePromptHandlerTest {

    @Inject
    LanguagePromptHandler handler;
    ...
    private static UpdateContext ctx() {
        return new UpdateContext(100L, "private", 200L, null, "/language", null, null, false, "bob", null, null, null);
    }

    @Test
    void handle_sendsPromptAndAdvancesToWaitChoice() {
        Session s = session();
